...
//      https://github.com/yderidde/PGMidi/blob/master/Sources/PGMidi/PGMidiSession.mm#L186
    ...
    public class MIDITempoListener: NSObject {
        ...
        ///
        /// - Parameters:
        ///   - smoothing: [0 - 1] this value controls the tick smoothing and bpm smoothing (currently both are
        /// disabled)
    ...
    extension MIDITempoListener: MIDIListener {
        ...
        ///
        public func receivedMIDISystemCommand(
            _ data: [MIDIByte],
        ...
        ///   - timeStamp:  MIDI Event TimeStamp
        ///
        public func receivedMIDIController(_: MIDIByte,
