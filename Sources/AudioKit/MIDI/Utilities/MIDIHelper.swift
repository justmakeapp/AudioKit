...
public enum MIDIHelper {
    /// Convert MIDI Bytes to 16 bit
    /// - Parameters:
    ///   - msb: Most significant bit
    ///   - lsb: Least significant bit
    /// - Returns: 16 bit integer
    public static func convertTo16Bit(msb: MIDIByte, lsb: MIDIByte) -> UInt16 {
    ...
    public static func convertTo32Bit(msb: MIDIByte, data1: MIDIByte, data2: MIDIByte, lsb: MIDIByte) -> UInt32 {
    ...
    public static func convertToString(bytes: [MIDIByte]) -> String {
    ...
    public static func convertToASCII(bytes: [MIDIByte]) -> String? {
