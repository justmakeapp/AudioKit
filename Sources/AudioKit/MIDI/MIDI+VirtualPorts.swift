// Copyright AudioKit. All Rights Reserved. Revision History at http://github.com/AudioKit/AudioKit/
    ...
    public extension MIDI {
        ...
        ///   - inputPortNames: Optional list of names for the input port(s) (otherwise they are automatically
        /// generated)
        ///   - outputPortNames: Optional list of names for the output port(s) (otherwise they are automatically
        /// generated)
        func createVirtualPorts(count: Int = 1,
        ...
        func createVirtualInputPorts(count: Int = 1, uniqueIDs: [Int32]? = nil, names: [String]? = nil) {
            ...
            var unIDPortIndex = Int32(startIndex)
        ...
        ///   - uniqueIDs: Optional list of IDs (otherwise they are automatically generated)
        ///   - names: Optional list of names (otherwise they are automatically generated)
        func createVirtualOutputPorts(count: Int = 1, uniqueIDs: [Int32]? = nil, names: [String]? = nil) {
            guard count > 0 else { return Log("Error: Number of port to create can't be less than one)",
                                              log: OSLog.midi, type: .error) }
        ...
        ///
        @discardableResult func destroyAllVirtualInputPorts() -> Bool {
            if virtualInputs != [0] {
        ...
        ///
        @discardableResult func destroyAllVirtualOutputPorts() -> Bool {
            if virtualOutputs != [0] {
