// Copyright AudioKit. All Rights Reserved. Revision History at http://github.com/AudioKit/AudioKit/
    ...
    public extension MIDI {
        ...
        var destinationRefs: [MIDIEndpointRef] {
        ...
        ///
        func destinationName(for destUid: MIDIUniqueID) -> String {
        ...
        ///
        func uidForDestinationAtIndex(_ outputIndex: Int = 0) -> MIDIUniqueID {
        ...
        ///
        func openOutput(index outputIndex: Int) {
        ...
        ///
        func openOutput(uid outputUid: MIDIUniqueID) {
            if outputPort == 0 {
            ...
            if outputUid == 0 {
                ...
                _ = zip(destinationUIDs, destinations)
                    .first { (arg: (MIDIUniqueID, MIDIDestinations.Element)) -> Bool in
                        let (uid, _) = arg
        ...
        ///
        func closeOutput(index outputIndex: Int) {
            guard outputIndex < destinationNames.count else {
                return
            }
            let uid = uidForDestinationAtIndex(outputIndex)
        ...
        ///
        func closeOutput(uid outputUid: MIDIUniqueID) {
        ...
        func sendNoteOnMessage(noteNumber: MIDINoteNumber,
        ...
        ///   - channel: MIDI Channel (default: 0)
        func sendControllerMessage(_ control: MIDIByte,
                                   value: MIDIByte,
                                   channel: MIDIChannel = 0,
                                   endpointsUIDs: [MIDIUniqueID]? = nil,
                                   virtualOutputPorts: [MIDIPortRef]? = nil) {
            let controlCommand = MIDIByte(0xB0) + channel
        ...
        func sendPitchBendMessage(value: UInt16,
                                  channel: MIDIChannel = 0,
                                  endpointsUIDs: [MIDIUniqueID]? = nil,
                                  virtualOutputPorts: [MIDIPortRef]? = nil) {
        ...
        ///   - time: MIDI Timestamp (default: mach_absolute_time(), note: time should never be 0)
        func sendMessage(_ data: [MIDIByte],
                         time: MIDITimeStamp = mach_absolute_time(),
                         endpointsUIDs: [MIDIUniqueID]? = nil,
                         virtualOutputPorts: [MIDIPortRef]? = nil) {
