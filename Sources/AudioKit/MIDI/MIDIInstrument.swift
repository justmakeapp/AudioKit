...
import CoreAudio
    ...
    open class MIDIInstrument: Node, MIDIListener, NamedNode {
        ...
        ///
        open func receivedMIDIController(_: MIDIByte,
        ...
        ///   - timeStamp:  MIDI Event TimeStamp
        ///
        open func receivedMIDIAftertouch(noteNumber _: MIDINoteNumber,
                                         pressure _: MIDIByte,
        ...
        ///   - timeStamp:MIDI Event TimeStamp
        ///
        open func receivedMIDIAftertouch(_: MIDIByte,
                                         channel _: MIDIChannel,
                                         portID _: MIDIUniqueID? = nil,
                                         timeStamp _: MIDITimeStamp? = nil) {
            // Do nothing
        ...
        ///   - timeStamp:       MIDI Event TimeStamp
        ///
        open func receivedMIDIPitchWheel(_: MIDIWord,
                                         channel _: MIDIChannel,
                                         portID _: MIDIUniqueID? = nil,
                                         timeStamp _: MIDITimeStamp? = nil) {
            // Do nothing
        ...
        ///   - timeStamp:MIDI Event TimeStamp
        ///
        open func receivedMIDIProgramChange(_: MIDIByte,
                                            channel _: MIDIChannel,
                                            portID _: MIDIUniqueID? = nil,
                                            timeStamp _: MIDITimeStamp? = nil) {
            // Do nothing
        ...
        ///
        open func receivedMIDISystemCommand(_: [MIDIByte],
                                            portID _: MIDIUniqueID? = nil,
                                            timeStamp _: MIDITimeStamp? = nil) {
            // Do nothing
        }
        ...
        open func receivedMIDIPropertyChange(propertyChangeInfo _: MIDIObjectPropertyChangeNotification) {
            // Do nothing
        }

        /// Generic MIDI Notification
        open func receivedMIDINotification(notification _: MIDINotification) {
            // Do nothing
        }
        ...
        ///
        open func start(noteNumber _: MIDINoteNumber,
                        velocity _: MIDIVelocity,
                        channel _: MIDIChannel,
                        timeStamp _: MIDITimeStamp? = nil) {
        ...
        ///
        open func stop(noteNumber _: MIDINoteNumber,
                       channel _: MIDIChannel,
                       timeStamp _: MIDITimeStamp? = nil) {
            // Override in subclass
        }
